...
const ImageDecomposerClient = dynamic(() => import("./client"), {
  loading: () => (
...
export const metadata: Metadata = {
  ...
  title: "AI Image Decomposer | Split Any Photo Into 3D Layers",
  description:
  ...
  openGraph: {
    title: "AI Image Decomposer - Split Photos into Layers",
    description:
  ...
  twitter: {
    ...
    title: "AI Image Decomposer | DeepShark AI",
    description:
