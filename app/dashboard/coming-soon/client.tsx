...
const ComingSoonPage = () => {
  return (
    <div className="flex flex-col items-center justify-center h-full min-h-[80vh] p-6 text-center text-gray-400 animate-in fade-in duration-500">
      ...
      <Link href="/dashboard">
        <Button className="bg-gradient-to-r from-cyan-500 to-teal-500 hover:from-cyan-600 hover:to-teal-600 text-black shadow-lg transition-all hover:scale-105 gap-2">
